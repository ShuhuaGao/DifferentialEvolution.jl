...
export Evolver, Options, Controller, DEEvolver, DEOptions

export pop, fitness, senses, bounds, options, nindividuals, nobjectives, best_fitness, best_individual,
    ...
    bounce_back!, demo!, StdSoDE, StdMoDE
